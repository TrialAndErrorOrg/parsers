...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "NonCiteContent$ebnf$2", "symbols": [(lexer.has("Rp") ? {type: "Rp"} : Rp)], "postprocess": id},
    {"name": "NonCiteContent$ebnf$2", "symbols": [], "postprocess": () => null},
    {"name": "NonCiteContent", "symbols": [(lexer.has("Lp") ? {type: "Lp"} : Lp), "NonCiteContent$ebnf$1", "NonCiteContent$ebnf$2"], "postprocess": ([l,c,r]) => l+c.join('')+r},
    {"name": "NonCiteContent$ebnf$3", "symbols": [(lexer.has("Lp") ? {type: "Lp"} : Lp)], "postprocess": id},
    {"name": "NonCiteContent$ebnf$3", "symbols": [], "postprocess": () => null},
    {"name": "NonCiteContent$ebnf$4", "symbols": ["NonYearParenContent"]},
    {"name": "NonCiteContent$ebnf$4", "symbols": ["NonCiteContent$ebnf$4", "NonYearParenContent"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "NonCiteContent", "symbols": ["NonCiteContent$ebnf$3", "NonCiteContent$ebnf$4", (lexer.has("Rp") ? {type: "Rp"} : Rp)], "postprocess": ([l,c,r]) => l+c.join('')+r},
