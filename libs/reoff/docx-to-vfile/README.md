...
```ts
docxToVFile(file: ArrayBuffer, options: Options = ...): Promise<VFile>;
```
...
Defined in:  [lib/docx-to-vfile-unzipit.ts:14](https://github.com/TrialAndErrorOrg/parsers/blob/34b3326/libs/reoff/docx-to-vfile/src/lib/docx-to-vfile-unzipit.ts#L14)
...
Defined in:  [lib/docx-to-vfile-unzipit.ts:11](https://github.com/TrialAndErrorOrg/parsers/blob/34b3326/libs/reoff/docx-to-vfile/src/lib/docx-to-vfile-unzipit.ts#L11)
