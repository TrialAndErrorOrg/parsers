...
import { P, Root, Node, R } from 'ooxast'
...
const isHeading = (child: Node) => {
  if (!isP(child)) return { heading: undefined }

  const pstyle = getPStyle(child)?.toLowerCase()
  return { heading: pstyle }
}
