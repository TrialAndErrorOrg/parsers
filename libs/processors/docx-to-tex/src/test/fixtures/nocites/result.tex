...
@article{Holden2009,
    title       = {Blame the people vs. fix the system},
    author      = {Holden, R.J.},
    number      = {2},
    volume      = {22},
    doi         = {10.1002/mare.4080220211},
    publisher   = {Wiley},
    year        = {1999-02},
    pages       = {7-8},
    journal     = {Management Report for Nonunion Organizations}
}
