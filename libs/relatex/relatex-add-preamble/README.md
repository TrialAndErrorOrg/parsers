...
Defined in:  [lib/relatex-add-preamble.ts:6](https://github.com/TrialAndErrorOrg/parsers/blob/5af9c17/libs/relatex/relatex-add-preamble/src/lib/relatex-add-preamble.ts#L6)
