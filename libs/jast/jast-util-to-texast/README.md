...
```sh
yarn add jast-jast-util-to-texast
```

or with [npm](https://docs.npmjs.com/cli/install)

```sh
npm install jast-jast-util-to-texast
```
...
[jast-jast-util-to-texast]: https://github.com/journaloftrialanderror/jote/tree/main/libs/rejour/jast-jast-util-to-texast
