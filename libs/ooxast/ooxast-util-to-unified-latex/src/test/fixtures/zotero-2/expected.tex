...
\begin{filecontents}{bibliography.bib}
	@article{A.U.T.H.O.R.2020,
    author      = {{A. U. T. H. O. R.}},
    date        = {2020}
}


@article{A.U.T.H.O.R.2014,
    author      = {{A. U. T. H. O. R.}},
    date        = {2014}
}


@article{CSL\_BIBLIOGRAPHYAnderson2019,
    title       = {On the automaticity of attentional orienting to threatening stimuli},
    author      = {CSL\_BIBLIOGRAPHYAnderson, A. D. D. I. N. ZOTERO\_BIBL {"uncited",],"omitted",],"custom",]} and A., B. and Britton, M. K.},
...
@article{Cane2009,
    title       = {The addiction Stroop task: {E}xamining the fast and slow effects of smoking and marijuana-related cues},
...
@article{Carlson2020,
    title       = {The stability and reliability of attentional bias measures in the dot-probe task: {E}vidence from both traditional mean bias scores and trial-level bias scores},
...
@article{Carlson2014,
    title       = {Attending to the fear in your eyes: {F}acilitated orienting and delayed disengagement},
...
@article{Duthoo2014,
    title       = {The heterogeneous world of congruency sequence effects: {A}n update},
...
@article{Gladwin2020,
    title       = {Attentional bias for negative expressions depends on previous target location: {R}eplicable effect but unreliable measures},
...
@article{Ho2019,
    title       = {Moving beyond P values: {D}ata analysis with estimation graphics},
...
@article{Kruijt2016,
    title       = {Capturing Dynamics of Biased Attention: {A}re New Attention Variability Measures the Way Forward?},
...
@article{Kruijt2018,
    title       = {A Meta-Analysis of Bias at Baseline in {RCT}s of Attention Bias Modification: {N}o Evidence for Dot-Probe Bias Towards Threat in Clinical Anxiety and {PTSD}},
...
@article{Mogg2017,
    title       = {Attention Bias Modification ({ABM}): {R}eview of Effects of Multisession {ABM} Training on Anxiety and Threat-Related Attention in High-Anxious Individuals},
...
@article{Posner1985,
    title       = {Inhibition of return: {N}eural basis and function},
...
@article{Schubö2006,
    title       = {Detecting emotional faces and features in a visual search paradigm: {A}re faces special?},
