...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "Input", "symbols": ["Input$ebnf$1"], "postprocess":  (inp)=>{
        const [content] = inp
        return content
              .reduce((acc: any[],
    ...
    {"name": "LocContent", "symbols": ["LocContent$ebnf$3"], "postprocess":  ([loc]) => {
    ...
    {"name": "LocGenericContent", "symbols": ["LocGenericContent", "Year"], "postprocess": ([content, year]) => `${content}${year}`},
    ...
    {"name": "GenericContent", "symbols": [(lexer.has("Quote") ? {type: "Quote"} : Quote)], "postprocess": id},
    ...
    {"name": "NameList$ebnf$1", "symbols": [(lexer.has("Com") ? {type: "Com"} : Com)], "postprocess": id},
    {"name": "NameList$ebnf$1", "symbols": [], "postprocess": () => null},
    {"name": "NameList", "symbols": ["Name", (lexer.has("Com") ? {type: "Com"} : Com), (lexer.has("__") ? {type: "__"} : __), "Name", (lexer.has("Com") ? {type: "Com"} : Com), (lexer.has("__") ? {type: "__"} : __), "Name", "NameList$ebnf$1", (lexer.has("__") ? {type: "__"} : __), "Comp", (lexer.has("__") ? {type: "__"} : __), "NameList"], "postprocess": ([name,,,nametwo,,,namethree,,,,,namefour])=>([name,nametwo,namethree,namefour].flat())},
    {"name": "NameList$ebnf$2", "symbols": [(lexer.has("Com") ? {type: "Com"} : Com)], "postprocess": id},
    {"name": "NameList$ebnf$2", "symbols": [], "postprocess": () => null},
    {"name": "NameList", "symbols": ["Name", (lexer.has("Com") ? {type: "Com"} : Com), (lexer.has("__") ? {type: "__"} : __), "Name", "NameList$ebnf$2", (lexer.has("__") ? {type: "__"} : __), "Comp", (lexer.has("__") ? {type: "__"} : __), "NameList"], "postprocess": ([name,,,n,,,,,nn])=>([name,n,nn].flat())},
    ...
    {"name": "NameList", "symbols": ["NameList", "Comp", (lexer.has("__") ? {type: "__"} : __), "NameList"], "postprocess": ([name,,,,])=>([name].flat())},
    {"name": "NameList", "symbols": ["NameList", (lexer.has("__") ? {type: "__"} : __), "Comp", (lexer.has("__") ? {type: "__"} : __), "Name"], "postprocess": ([name,_,and,,n])=>([name,n].flat())},
    ...
    {"name": "NameList", "symbols": ["NameList", (lexer.has("Apo") ? {type: "Apo"} : Apo), {"literal":"s"}], "postprocess": ([name])=>([name, "'s"].flat())},
    ...
    {"name": "McConnel", "symbols": [(lexer.has("Mc") ? {type: "Mc"} : Mc), "McConnel$ebnf$1"], "postprocess": ([mac, low]) =>({family:[mac, low.join('')].join('')})},
