...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    { name: 'ParenNameMaybe', symbols: ['Name'], postprocess: id },
    {
      ...
      postprocess: ([n, , nn]) => ({ family: n.family + nn.family }),
    },
    {
      name: 'ParenNameMaybe',
      symbols: [
      ...
      postprocess: ([n, , nn]) => ({ family: n.family + nn }),
    },
    {
      name: 'Etal$ebnf$1',
      symbols: [lexer.has('__') ? { type: '__' } : __],
    ...
    },
    {
      ...
      postprocess: ([year, sl, year2]) => year2,
    },
    {
      name: 'Year$ebnf$1',
      symbols: [lexer.has('Dash') ? { type: 'Dash' } : Dash],
